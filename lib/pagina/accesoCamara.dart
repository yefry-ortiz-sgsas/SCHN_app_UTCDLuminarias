...
class AccesoCamaraPage extends StatefulWidget {
  @override
  _AccesoCamaraPagePageState createState() => _AccesoCamaraPagePageState();
}

class _AccesoCamaraPagePageState extends State<AccesoCamaraPage>
      ...
      body: Padding(
        ...
        child: Center(
          ...
          children: [
            ...
            Text(
                'Para poder brindarle una mejor experiencia y que pueda tener un mejor acceso a la información, necesitamos el acceso a su camara.'),
            SizedBox(height: 10.0),
            MaterialButton(
                child: Text('Brindar Acceso a Camara',
  ...
  void accesoGPS(PermissionStatus status) async {
    switch (status) {
      ...
      case PermissionStatus.permanentlyDenied:
        show(context, "Alerta", "Por favor brinde los permisos de la camara.", 3);
        openAppSettings();
        break;
